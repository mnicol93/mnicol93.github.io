...
function toggleLoading(isLoading) {
  ...
  // TRUE  - <i class="fas fa-hourglass-half"></i>
  // FALSE - <i class="fas fa-search"></i>
  const btnSearch = document.querySelector('#btnSearch');
  if(isLoading){
    btnSearch.innerHTML = "Loading... <i id=\"btn-icon\"class=\"fas fa-hourglass-half\"></i>"
    btnSearch.disabled = true;
  }else{
    btnSearch.innerHTML = "Search <i id=\"btn-icon\"class=\"fas fa-search\"></i>";
